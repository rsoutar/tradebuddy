...
- Logging, backtesting, simulation mode, and risk controls
...
- Backtesting and paper/simulation mode
...
- Phase 3: Frontend, onboarding, charts, logs, backtesting UX
...
- [ ] Implement simulation mode execution path separate from live trading
...
### 4.11 Web Frontend with TanStack Start
...
### 4.12 Backtesting and Simulation
...
### 4.13 Logging, Reporting, and Export
...
- [ ] Validate simulation mode against expected strategy behavior
...
### 4.16 Beta Readiness and Documentation
...
3. Shared strategy engine and simulation mode
4. Grid Bot
5. Rebalance Bot
6. Infinity Grid Bot
7. Risk management
...
9. CLI
10. Web frontend
11. Backtesting, logging, and export
12. Security, testing, and beta readiness
...
- [ ] User can run all strategies in simulation mode before live trading
...
- [ ] Logs and CSV exports are available for trades, errors, and AI interactions
